              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        ...
                        <br />
                        Restaurant Partners: 1800-765-4321
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        General: support@swiggy.com
                        <br />
                        Partners: partners@swiggy.com
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  ...
                  <div className="flex space-x-4">
                    <Link
                      to="#"
                      className="bg-orange-500 hover:bg-orange-600 text-white p-3 rounded-lg transition-colors duration-200"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="currentColor"
